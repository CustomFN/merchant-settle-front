...
export const constantRouterMap = [
...

  {
    ...
    meta: { title: '客户管理', icon: 'icon-fenleiorguangchangorqitatianchong', requireLogin: true },
    children: [
      {
        path: 'customermanager',
        name: '客户列表',
        component: () => import('@/views/pages/customer/CustomerManager'),
        meta: { title: '客户列表', requireLogin: true }
      },
      {
        path: 'contractmanager',
        name: '合同列表',
        component: () => import('@/views/pages/customer/ContractManager'),
        meta: { title: '合同列表', requireLogin: true }
      },
      {
        path: 'customeroplog',
        name: '客户操作记录',
        ...
        hidden: true,
        meta: { title: '客户操作记录', requireLogin: true }
      },
      {
        path: 'customerinfo',
        name: '客户信息',
        ...
        hidden: true,
        meta: { title: '客户信息', requireLogin: true }
      }
    ]
  },

  {
    ...
    children: [
      ...
      },
      {
        ...
        hidden: true,
        meta: { title: '物理门店信息', requireLogin: true }
      },
      {
        path: 'wmpoiinfo',
        name: '外卖门店信息',
        ...
        hidden: true,
        meta: { title: '外卖门店信息', requireLogin: true }
      },
      {
        path: 'wmpoioplog',
        name: '外卖门店操作记录',
        component: () => import('@/views/pages/poi/WmPoiOpLog'),
        hidden: true,
        meta: { title: '外卖门店操作记录', requireLogin: true }
      }
    ]
  },
    ...
    children: [
      {
        ...
        meta: { title: '所有任务', requireLogin: true }
      },
      {
        path: 'tasks',
        name: '个人任务',
        component: () => import('@/views/pages/audit/AuditTaskHandle'),
        meta: { title: '个人任务', requireLogin: true }
      },
      {
        path: 'auditcustomer',
        name: '客户审核',
        ...
        hidden: true,
        meta: { title: '客户审核', requireLogin: true }
      },
      {
        ...
        hidden: true,
        meta: { title: '客户KP审核', requireLogin: true }
      },
      {
        ...
        hidden: true,
        meta: { title: '客户合同审核', requireLogin: true }
      },
      {
        ...
        hidden: true,
        meta: { title: '客户结算审核', requireLogin: true }
      },
      {
        ...
        hidden: true,
        meta: { title: '门店基本信息审核', requireLogin: true }
      },
      {
        path: 'auditwmpoiqua',
        name: '门店资质信息审核',
        ...
        hidden: true,
        meta: { title: '门店资质信息审核', requireLogin: true }
      },
      {
        ...
        hidden: true,
        meta: { title: '门店配送信息审核', requireLogin: true }
      },
      {
        ...
        hidden: true,
        meta: { title: '门店营业信息审核', requireLogin: true }
      }
    ]
  },
    ...
    children: [
      {
        ...
        meta: { title: '用户管理', requireLogin: true }
      },
      {
        path: 'role',
        name: '角色管理',
        component: () => import('@/views/pages/upm/RoleManager'),
        meta: { title: '角色管理', requireLogin: true }
      },
      {
        path: 'resource',
        name: '资源管理',
        component: () => import('@/views/pages/upm/ResourceManager'),
        meta: { title: '资源管理', requireLogin: true }
      }
    ]
  }
]
